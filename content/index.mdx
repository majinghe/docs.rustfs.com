...
<Cards>
  ...
  <Card icon={<Container />} title="Run with Docker" href="/installation/container">
...
<Cards>
  ...
  <Card icon={<ClipboardCheck />} title="Checklist" href="/installation/requirement/checklists/hardware-checklists">
    Hardware, network, software, and security prep.
  </Card>
  <Card icon={<Activity />} title="Operations" href="/operations/upgrade">
