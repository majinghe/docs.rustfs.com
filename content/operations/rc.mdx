...
`rc` is the RustFS command-line client for S3 object operations and RustFS administration. This guide installs `rc`, configures a cluster alias, and introduces the main inspection commands. The download examples use `v0.1.29`; check the [RustFS CLI releases](https://github.com/rustfs/cli/releases) for a newer version before installing.
...
```bash
curl -fLO https://github.com/rustfs/cli/releases/download/v0.1.29/rustfs-cli-linux-amd64-v0.1.29.tar.gz
tar -xzf rustfs-cli-linux-amd64-v0.1.29.tar.gz
...
```bash
curl -fLO https://github.com/rustfs/cli/releases/download/v0.1.29/rustfs-cli-linux-arm64-v0.1.29.tar.gz
tar -xzf rustfs-cli-linux-arm64-v0.1.29.tar.gz
sudo install -m 0755 rc /usr/local/bin/rc
```
...
```bash
curl -fLO https://github.com/rustfs/cli/releases/download/v0.1.29/rustfs-cli-macos-amd64-v0.1.29.tar.gz
tar -xzf rustfs-cli-macos-amd64-v0.1.29.tar.gz
sudo install -m 0755 rc /usr/local/bin/rc
```
...
```bash
curl -fLO https://github.com/rustfs/cli/releases/download/v0.1.29/rustfs-cli-macos-arm64-v0.1.29.tar.gz
tar -xzf rustfs-cli-macos-arm64-v0.1.29.tar.gz
sudo install -m 0755 rc /usr/local/bin/rc
```
